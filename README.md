...
- **client_files**: these are example files showing how to receive and use data from the pods. Currently, there are SuperCollider and Max/MSP examples.
...
- **depricated**: contains depricated versions of the CAFFEINE software. We do not recommend using the versions in this file.
- **utilities**: this folder contains the test suite of programs used to procure analysis data of data transmission rates for the CAFFEINE paper.
- **CAD**: contains CAD files for the enclosure
